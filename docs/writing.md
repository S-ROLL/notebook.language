...
> - **Overview > 2 sentences** $\rightarrow$ into 1 paragraph, overview 1 paragraph.
> - **Overview = 1 sentence** $\rightarrow$ into & overview 1 paragraph.
...
### Goal
- **Time period**:
  - $\rightarrow$ changes (starting - ending point).
  - $\rightarrow$ comparison among the categories.
- **Discrete categories** $\rightarrow$ comparison among the categories.
### Describe key trends
...
> - Intransitive verb $\rightarrow$ **adv** + v $\rightarrow$ v + **adv**.
> - Transitive verb $\rightarrow$ **adv** + VO $\rightarrow$ VO + **adv**.
...
E.G. 5 thousand dollar**s**, 300 million car**s**, 15.7%.
...
| Task 1 - Full body | [submit](https://drive.google.com/drive/folders/12FtGKjZr5HsIoKZr1qPCO2Bbx2QKVwzU?fbclid=IwZXh0bgNhZW0CMTAAAR3VcPj_bP5Lhgtw4noADCS_BeoyAQrcZPetl4EuvoxRDqbkx0vb2HoYI7Y_aem_Qb5_LqDZofhWCCkCwKR3jw) | |